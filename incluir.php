<?php
    ...
    if(isset($_POST['email']) && isset($_POST['senha'])){
        ...
        $sql = "INSERT INTO sistemalogin (email,senha) VALUES ('$email','$senha')";
        $result = mysqli_query($conn,$sql);
        if($result==1){
            echo"<script>alert('Usuário incluido com sucesso!')</script>";
...
?>
    ...
    <h1 style="text-align: center; margin-top: 50px;">Incluir novo usuário</h1>
