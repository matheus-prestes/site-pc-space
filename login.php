<html>
  ...
  <body>
    ...
    <h1 style="text-align: center; margin-top: 50px;">Login | Cadastro</h1>
      ...
      <div class="row">
        <div class="col" style="border-style: solid; border-color: #f0f0f0; padding: 20px; margin: 10px;">
          <form method="post" action="valida.php">
            ...
            <button type="submit" class="btn btn-light">Esqueci minha senha</button><br><br>
            <button type="submit" class="btn btn-primary" name="entrar" value="Login">Entrar</button>
          </form>
        </div>
        <div class="col" style="border-style: solid; border-color: #f0f0f0; padding: 20px; margin: 10px;">
          <formmethod="post">
