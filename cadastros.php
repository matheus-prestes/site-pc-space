...
<html>
  ...
  <body>
    ...
    <h1 style="text-align: center; margin-top: 50px;">Cadastro de usuários</h1>

    <div class="text-center"><a href="incluir.php"><button type="button" class="btn btn-success" style="margin-top:50px;">Incluir usuário</button></a></div>
    ...
    <?php
        ...
        $sql = mysqli_query($conn, "SELECT * FROM sistemalogin");
        while($aux = mysqli_fetch_array($sql)){
            ...
            <th scope='row'>".$id."</th>
            <td>".$email."</td>   
            <td><a href='editar.php?id=".$id."'><button type='button' class='btn btn-warning'>Editar</button></a></td>
            <td><a href='excluir.php?id=".$id."'><button type='button' class='btn btn-danger'>Excluir</button></td>         
            </tr>";           
        }
